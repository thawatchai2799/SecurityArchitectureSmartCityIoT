...
const doc = new Document({ styles: { default: { document: { run: { font: F, size: 20 } } } }, sections: [{
  ...
  children: [
    new Paragraph({ children: [new TextRun({ text: "Supplementary Material — addendum for the revised manuscript (revise-v15)", font: F, size: 24, bold: true })], spacing: { after: 120 } }),
    ...
    p([t("Colour key (same as the revised manuscript and the response letter): ", { bold: true }), t("green = added or replaced for Reviewer 1", { shading: sh(FILL.G) }), t("; "), t("pink = for Reviewer 3", { shading: sh(FILL.P) }), t("; "), t("yellow = for Reviewer 2", { shading: sh(FILL.Y) }), t("; "), t("purple = for the Editor", { shading: sh(FILL.V) }), t("; "), t("grey = corrected by the authors in self-review", { shading: sh(FILL.S) }), t(". Each section heading below is shaded with the colour of the reviewer whose comment it answers; every number in this addendum was regenerated under release v2.1.0, and the numbers that moved relative to the first revision because of the authors\u2019 own corrections are listed in the repository CHANGELOG (v2.1).")]),
